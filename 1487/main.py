        ...
        for i, s in enumerate(names):
            ...
            if s in klist:
                ...
                if v:
                    ...
                    # if name is update, create or update klist[str(v)]
                    if not ns in klist:
                        klist[ns] = []
                    klist[ns].append(0)
                    continue
            ...
            # add n in str(n) in to klist[str]
            if s[-1] == ')':
                l = s.rfind('(')
                t = s[l+1:-1]       # n
                p = s[0:l]          # str
